...
<script type="text/javascript">
	<c:if test="${empty articleId.id}">
	alert("로그인을 해주시고 글을 작성하여주시기 바랍니다.");
...
<body>
	...
	<form  method="post" action="${contextPath}/board/addArticle.do"	enctype="multipart/form-data">
		<table border=1 align="center">
			<tr>
				<td align="right">작성자 아이디 :</td>
				<td colspan="2">
				<input type="hidden" value="${articleId.id}" name="id" />
				${articleId.id}
				</td>
			</tr>
			<tr>
				<td align="right">작성자 이름 :</td>
				<td colspan="2">
				${articleId.name}
				</td>
			</tr>
